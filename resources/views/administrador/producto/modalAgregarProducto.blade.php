                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <select class="form-control input-lg seleccionarTipo" id="producto">
                    ...
                    <!--=====================================
                     ...
                     ======================================-->
                    <div class="form-group">
                        <div class="input-group" id="categoriaProducto">
                            <span class="input-group-addon"><i class="fa fa-th"></i></span>
                    ...
                    <!--=====================================
                     ...
                     ======================================-->
                    <div class="form-group">
                        <div class="input-group" id="jsubcategoriaProducto">
                            <span class="input-group-addon"><i class="fa fa-th"></i></span>
                            <select name="idciudad" class="form-control input-lg seleccionarTipo" required>
                                <option selected value="none" disabled="disabled">Selecionar Ciudad</option>
                                @foreach ($ciudad as $c)
